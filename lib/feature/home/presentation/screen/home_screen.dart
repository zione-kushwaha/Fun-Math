...
import 'package:fun_math/feature/home/presentation/widgets/math_character.dart';
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: isDarkMode
              ? [
                  const Color(0xFF6A5AE0).withValues(alpha: .3),
        ...
        border: Border.all(
          color: isDarkMode
              ? const Color(0xFF6A5AE0).withValues(alpha: .5)
              : const Color(0xFF6A5AE0).withValues(alpha: .2),
          width: 1,
        ),
      ),
      child: Row(

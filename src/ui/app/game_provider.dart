...
import '/src/data/repository/correct_answer_repository.dart';
import '/src/data/repository/math_pairs_repository.dart';
import '/src/data/repository/mental_arithmetic_repository.dart';
import '/src/data/repository/picture_puzzle_repository.dart';
import '/src/data/repository/quick_calculation_repository.dart';
import '/src/data/repository/square_root_repository.dart';
import '/src/data/repository/sign_repository.dart';
...
class GameProvider<T> extends TimeProvider {
  ...
  GameProvider({
    ...
    required this.difficultyType,
         ...
         vsync: vsync,
         totalTime: KeyUtil.getTimeUtil(gameCategoryType, difficultyType),
       );

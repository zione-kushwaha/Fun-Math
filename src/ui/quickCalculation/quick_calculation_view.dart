...
import '/src/ui/quickCalculation/quick_calculation_question_view.dart';
import '/src/ui/quickCalculation/quick_calculation_provider.dart';
...
class QuickCalculationView extends StatelessWidget {
  ...
  const QuickCalculationView({Key? key, required this.colorTuple})
    : super(key: key);
    ...
    return MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider<QuickCalculationProvider>(
          create:
              (context) => QuickCalculationProvider(

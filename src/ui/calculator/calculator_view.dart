...
import '/src/ui/calculator/calculator_provider.dart';
...
class CalculatorView extends StatelessWidget {
  ...
  const CalculatorView({Key? key, required this.colorTuple}) : super(key: key);
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    Selector<CalculatorProvider, Tuple2<double, double>>(
                      selector:
                          (p0, p1) => Tuple2(p1.currentScore, p1.oldScore),
